...
<p align="center"><img src="images/tropelex-hero-static.jpg?v=2" alt="Tropelex — The Rationale Engine for AI"/></p>
...
<p align="center"><img src="images/diagrams/safety-gate.png?v=2" alt="Safety gate flow: a submitted decision without an explicit safety category is blocked with a suggested category; once written, it gets a content hash, an audit event chained to the prior entry's hash, a Decision Tree update, and ongoing Drift/Ghost contradiction checks"/></p>
